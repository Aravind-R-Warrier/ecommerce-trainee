...
const navArr = [
  { link: '/', component: 'Dashboard', icon: <DashboardIcon /> },
  { link: '/users', component: 'Users', icon: <GroupIcon /> },
  { link: '/products', component: 'Products', icon: <LocalGroceryStoreIcon /> },
  { link: '/coupons', component: 'Coupon', icon: <RedeemIcon /> },
];
